...
#define FOR_WITH_COMMA_(N, Macro, ...) EXPAND(CONCATENATE(FOR_WITH_COMMA_, N)(Macro, __VA_ARGS__))
...
#define FOR_WITH_SEPARATOR_(N, Macro, Separator, ...) EXPAND(CONCATENATE(FOR_WITH_SEPARATOR_, N)(Macro, Separator, __VA_ARGS__))
