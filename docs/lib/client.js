...
const monaco_converter_1 = require("@codingame/monaco-languageclient/lib/monaco-converter");
...
function createDocument(model) {
    return vscode_json_languageservice_1.TextDocument.create(MODEL_URI, model.getLanguageId(), model.getVersionId(), model.getValue());
}
...
const m2p = new monaco_converter_1.MonacoToProtocolConverter(monaco);
const p2m = new monaco_converter_1.ProtocolToMonacoConverter(monaco);
